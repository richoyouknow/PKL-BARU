    ...
    <div
        ...
        <div class="w-full max-w-md">
            ...
            <form action="{{ route('login') }}" method="POST" class="space-y-6">
                ...
                <div>
                    <label class="block text-sm font-medium mb-1.5 text-slate-700 dark:text-slate-300" for="login">
                        <span class="text-red-500 mr-1">*</span>Email atau No. HP
                    </label>
                    <input
                        class="w-full px-4 py-2.5 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all placeholder:text-slate-400 dark:placeholder:text-slate-500 @error('login') border-red-500 @enderror"
                        id="login"
                        name="login"
