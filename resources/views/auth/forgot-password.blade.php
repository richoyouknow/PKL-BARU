...
<head>
    ...
    <title>Lupa Kata Sandi - Koperasi Denmart</title>
    ...
    <div
        ...
        <div class="w-full max-w-md">
            ...
            <p class="text-slate-600 dark:text-slate-400 mb-8 text-sm">
                Masukkan email Anda yang terdaftar. Kami akan mengirimkan kode verifikasi ke email tersebut.
            </p>
            ...
            <div class="mt-6 text-center">
                <a class="text-primary font-semibold hover:underline flex items-center justify-center gap-1 text-sm"
                    href="{{ route('login') }}">
