    ...
    <div id="tailwind-scope">
        <main class="tw-flex-1 tw-w-full tw-max-w-[1200px] tw-mx-auto tw-p-4 md:tw-p-8">
            ...
            <div class="tw-mb-8 tw-flex tw-flex-col md:tw-flex-row md:tw-items-end tw-justify-between tw-gap-4">
                <div class="tw-flex-1">
                    <h1 class="tw-text-text-primary-light dark:tw-text-text-primary-dark tw-text-3xl md:tw-text-4xl tw-font-black tw-leading-tight tw-tracking-tight">
                        Profil Saya
                    </h1>
            ...
            <div class="tw-grid tw-grid-cols-1 lg:tw-grid-cols-12 tw-gap-6">
                <div class="lg:tw-col-span-4 xl:tw-col-span-3 tw-flex tw-flex-col tw-gap-6">
                    <div class="tw-bg-surface-light dark:tw-bg-surface-dark tw-rounded-xl tw-shadow-sm tw-border tw-border-border-light dark:tw-border-border-dark tw-p-6 tw-flex tw-flex-col tw-items-center tw-text-center">
                        ...
                        <div class="tw-flex tw-gap-2 tw-mt-4 tw-flex-wrap tw-justify-center">
                            <span class="tw-inline-flex tw-items-center tw-gap-1.5 tw-px-3 tw-py-1 tw-rounded-full tw-text-xs tw-font-semibold tw-bg-emerald-100 tw-text-emerald-800 dark:tw-bg-emerald-900 dark:tw-text-emerald-100">
                                <span class="tw-w-1.5 tw-h-1.5 tw-rounded-full tw-bg-emerald-500"></span>
                                {{ $status_label ?? 'Aktif' }}
                            </span>
                            @if(isset($is_pengurus) && $is_pengurus)
                                <span class="tw-inline-flex tw-items-center tw-gap-1.5 tw-px-3 tw-py-1 tw-rounded-full tw-text-xs tw-font-semibold tw-bg-primary/10 tw-text-primary dark:tw-bg-primary/20 dark:tw-text-blue-100">
                        ...
                        <div class="tw-w-full tw-flex tw-flex-col tw-gap-4 tw-text-left">
                            <div class="tw-flex tw-items-start tw-gap-3">
                                <span class="material-symbols-outlined tw-text-text-secondary-light dark:tw-text-text-secondary-dark">badge</span>
                                <div>
                                    <p class="tw-text-xs tw-text-text-secondary-light dark:tw-text-text-secondary-dark tw-font-medium">
                                        No. Anggota</p>
                                    <p class="tw-text-sm tw-font-semibold tw-text-text-primary-light dark:tw-text-text-primary-dark">
                                        {{ $anggota->no_anggota ?: 'Belum ada' }}</p>
                                </div>
                            </div>
                            <div class="tw-flex tw-items-start tw-gap-3">
                                <span class="material-symbols-outlined tw-text-text-secondary-light dark:tw-text-text-secondary-dark">confirmation_number</span>
                                <div>
                                    <p class="tw-text-xs tw-text-text-secondary-light dark:tw-text-text-secondary-dark tw-font-medium">
                                        No. Registrasi</p>
                                    <p class="tw-text-sm tw-font-semibold tw-text-text-primary-light dark:tw-text-text-primary-dark">
                            ...
                            <div class="tw-flex tw-items-start tw-gap-3">
                                <span class="material-symbols-outlined tw-text-text-secondary-light dark:tw-text-text-secondary-dark">groups</span>
                                <div>
                                    <p class="tw-text-xs tw-text-text-secondary-light dark:tw-text-text-secondary-dark tw-font-medium">
                                        Grup Wilayah</p>
                                    <p class="tw-text-sm tw-font-semibold tw-text-text-primary-light dark:tw-text-text-primary-dark">
                ...
                <div class="lg:tw-col-span-8 xl:tw-col-span-9 tw-flex tw-flex-col tw-gap-6">
                    {{-- Akun & Keanggotaan --}}
                    <div class="tw-bg-surface-light dark:tw-bg-surface-dark tw-rounded-xl tw-shadow-sm tw-border tw-border-border-light dark:tw-border-border-dark tw-overflow-hidden">
                        <div class="tw-px-6 tw-py-4 tw-border-b tw-border-border-light dark:tw-border-border-dark tw-flex tw-items-center tw-gap-2 tw-bg-slate-50 dark:tw-bg-slate-800/50">
                        ...
                        <div class="tw-p-6 tw-grid tw-grid-cols-1 md:tw-grid-cols-2 tw-gap-y-6 tw-gap-x-8">
                            <div>
                                <p class="tw-text-sm tw-text-text-secondary-light dark:tw-text-text-secondary-dark tw-mb-1">
                                    No. Registrasi</p>
                                <p class="tw-text-base tw-font-medium tw-text-text-primary-light dark:tw-text-text-primary-dark">
                                    {{ $anggota->no_registrasi }}</p>
                            </div>
                            <div>
                                <p class="tw-text-sm tw-text-text-secondary-light dark:tw-text-text-secondary-dark tw-mb-1">
                            ...
                            <div>
                                ...
                                <div class="tw-flex tw-items-center tw-gap-2">
                                    <div class="tw-w-6 tw-h-6 tw-rounded-full tw-bg-slate-200 dark:tw-bg-slate-700 tw-flex tw-items-center tw-justify-center tw-text-xs tw-font-bold tw-text-slate-600 dark:tw-text-slate-300">
                            ...
                            <div>
                                <p class="tw-text-sm tw-text-text-secondary-light dark:tw-text-text-secondary-dark tw-mb-1">
                                    Keterangan</p>
                                <p class="tw-text-base tw-font-medium tw-text-text-primary-light dark:tw-text-text-primary-dark {{ $anggota->keterangan ? '' : 'tw-italic tw-text-opacity-60' }}">
                    ...
                    <div class="tw-grid tw-grid-cols-1 md:tw-grid-cols-2 tw-gap-6">
                        <div class="tw-bg-surface-light dark:tw-bg-surface-dark tw-rounded-xl tw-shadow-sm tw-border tw-border-border-light dark:tw-border-border-dark tw-overflow-hidden tw-flex tw-flex-col tw-h-full">
                            <div class="tw-px-6 tw-py-4 tw-border-b tw-border-border-light dark:tw-border-border-dark tw-flex tw-items-center tw-gap-2 tw-bg-slate-50 dark:tw-bg-slate-800/50">
                            ...
                            <div class="tw-p-6 tw-flex tw-flex-col tw-gap-5 tw-flex-1">
                                ...
                                <div>
                                    <p class="tw-text-sm tw-text-text-secondary-light dark:tw-text-text-secondary-dark tw-mb-1">
                                        Nomor Identitas</p>
                                    <p class="tw-text-base tw-font-medium tw-text-text-primary-light dark:tw-text-text-primary-dark tw-font-mono tw-tracking-wide">
                            ...
                            <div class="tw-p-6 tw-flex tw-flex-col tw-gap-5 tw-flex-1">
                                ...
                                <div>
                                    ...
                                    <div class="tw-flex tw-items-start tw-gap-2">
                                        <span class="material-symbols-outlined tw-text-sm tw-text-primary tw-mt-1">home</span>
                                        <p class="tw-text-base tw-font-medium tw-text-text-primary-light dark:tw-text-text-primary-dark tw-leading-relaxed">
                                            {{ $anggota->alamat ?: '-' }}</p>
                                    </div>
                                </div>
                            </div>
