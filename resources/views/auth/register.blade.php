...
<body class="bg-background-light dark:bg-background-dark text-slate-900 dark:text-slate-100 min-h-screen">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    id="no_identitas" name="no_identitas" type="text"
                                    placeholder="Nomor identitas" value="{{ old('no_identitas') }}" required />
                                @error('no_identitas')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                placeholder="Kosongkan jika belum menikah" value="{{ old('nama_pasangan') }}" />
                            @error('nama_pasangan')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <select
                                ...
                                <option value="Karyawan Koperasi"
                                    {{ old('grup_wilayah') == 'Karyawan Koperasi' ? 'selected' : '' }}>Karyawan
                                    Koperasi</option>
                                <option value="Karyawan PKWT"
                                    {{ old('grup_wilayah') == 'Karyawan PKWT' ? 'selected' : '' }}>Karyawan PKWT
                                </option>
                                <option value="Karyawan Tetap"
                                    {{ old('grup_wilayah') == 'Karyawan Tetap' ? 'selected' : '' }}>Karyawan Tetap
                                </option>
                                <option value="Non Karyawan"
                                    {{ old('grup_wilayah') == 'Non Karyawan' ? 'selected' : '' }}>Non Karyawan</option>
                                <option value="Outsourcing"
                                    {{ old('grup_wilayah') == 'Outsourcing' ? 'selected' : '' }}>Outsourcing</option>
                                <option value="Pensiun" {{ old('grup_wilayah') == 'Pensiun' ? 'selected' : '' }}>
                                    Pensiun</option>
                                <option value="Petugas Gudang Pengolah"
                                    {{ old('grup_wilayah') == 'Petugas Gudang Pengolah' ? 'selected' : '' }}>Petugas
                                    Gudang Pengolah</option>
                            </select>
                            @error('grup_wilayah')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input
                                ...
                                placeholder="Contoh: Staff Admin, Manager, dll" value="{{ old('pekerjaan') }}"
                                required />
                            @error('pekerjaan')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <select
                                class="w-full px-4 py-2.5 bg-white dark:bg-slate-700 border border-slate-300 dark:border-slate-600 rounded focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all @error('nama_bank') border-red-500 @enderror"
                                id="nama_bank" name="nama_bank">
                                <option value="">Pilih Bank</option>
                                <option value="BCA" {{ old('nama_bank') == 'BCA' ? 'selected' : '' }}>BCA</option>
                                <option value="Mandiri" {{ old('nama_bank') == 'Mandiri' ? 'selected' : '' }}>Mandiri
                                </option>
                                <option value="BNI" {{ old('nama_bank') == 'BNI' ? 'selected' : '' }}>BNI</option>
                                <option value="BRI" {{ old('nama_bank') == 'BRI' ? 'selected' : '' }}>BRI</option>
                                <option value="CIMB Niaga" {{ old('nama_bank') == 'CIMB Niaga' ? 'selected' : '' }}>
                                    CIMB Niaga</option>
                                <option value="Danamon" {{ old('nama_bank') == 'Danamon' ? 'selected' : '' }}>Danamon
                                </option>
                                <option value="Maybank" {{ old('nama_bank') == 'Maybank' ? 'selected' : '' }}>Maybank
                                </option>
                                <option value="Bank Syariah Indonesia"
                                    {{ old('nama_bank') == 'Bank Syariah Indonesia' ? 'selected' : '' }}>Bank Syariah
                                    Indonesia</option>
                                <option value="Bank Lainnya"
                                    {{ old('nama_bank') == 'Bank Lainnya' ? 'selected' : '' }}>Bank Lainnya</option>
                            </select>
                            @error('nama_bank')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input
                                class="w-full px-4 py-2.5 bg-white dark:bg-slate-700 border border-slate-300 dark:border-slate-600 rounded focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all @error('no_rekening') border-red-500 @enderror"
                                id="no_rekening" name="no_rekening" type="text" placeholder="Nomor rekening bank"
                        ...
                        <div>
                            ...
                            <input
                                class="w-full px-4 py-2.5 bg-white dark:bg-slate-700 border border-slate-300 dark:border-slate-600 rounded focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all @error('atas_nama') border-red-500 @enderror"
                                id="atas_nama" name="atas_nama" type="text" placeholder="Nama pemilik rekening"
                                value="{{ old('atas_nama') }}" />
                            @error('atas_nama')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                            <p class="text-xs text-slate-500 mt-1">Harus sesuai dengan nama di buku tabungan</p>
                        </div>
    ...
    <!-- Dark Mode Toggle -->
    <button
        class="fixed bottom-6 right-6 p-3 rounded-full bg-slate-100 dark:bg-slate-800 shadow-lg hover:shadow-xl transition-all"
